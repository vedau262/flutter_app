...
import 'package:flutter_app/research/bloc/remote_bloc.dart';
import 'package:flutter_app/research/bloc/remote_event.dart';
import 'package:flutter_app/research/bloc/remote_state.dart';

class MyHomePageBloc extends StatefulWidget {
  // MyHomePageBloc({required Key key, required this.title}) : super(key: key);
